        ...
        <div className="px-8 py-8">
          {success ? (
            <div className="text-center">
              ...
              <p className="text-[#9A7060] text-sm mb-1">Un lien de réinitialisation a été envoyé si un compte existe avec cet email.</p>
              <p className="text-[#9A7060]/70 text-xs mb-8">Vérifiez aussi vos spams.</p>
              <Link to="/login"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3.5 bg-[#FDDDD4] border-0 rounded-2xl text-[#1A1A1A] placeholder-[#9A7060]/70 text-sm focus:outline-none focus:ring-2 focus:ring-[#C05015]/40 transition-all${error ? ' ring-2 ring-red-400' : ''}`}
                  />
                </div>
              ...
              <div className="pt-2">
                <Link to="/login" className="flex items-center gap-2 text-[#9A7060] hover:text-[#C05015] text-sm font-medium transition-colors">

    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-8 h-8 border-4 border-[#FF3A03] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {orders.length === 0 ? (
          <div className="bg-white rounded-2xl p-12 text-center">
            ...
            <Link
              to="/menu"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#FF3A03] text-white rounded-xl font-semibold hover:bg-[#CC2402] transition"
            >
            ...
            <div key={order.id} className="bg-white rounded-2xl p-6 shadow-sm border border-[#E2E8F0] mb-6">
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="text-right">
                  ...
                  <p className="text-lg font-bold text-[#FF3A03] mt-1">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="px-4 py-2 text-sm text-[#FF3A03] hover:bg-[#FFECDF] rounded-lg transition"
                >

  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-10"
      ...
      <div className="w-full max-w-md">
        ...
        {/* Card */}
        <div className="rounded-lg shadow-xl overflow-hidden" style={{ background: '#FFFFFF' }}>
            ...
            {step === 1 && (
              <div>
                ...
                <button onClick={handleProfilNext} disabled={saving}
                  className="mt-6 w-full py-3.5 rounded-lg font-bold text-sm text-white flex items-center justify-center gap-2"
                ...
                <div className="space-y-3 mb-6">
                  {POSTES.map(({ key, label, icon: Icon, desc }) => (
                    <button key={key} onClick={() => setPoste(key)}
                      className="w-full flex items-center gap-4 p-4 rounded-lg text-left transition"
                      style={{

    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="bg-white rounded-3xl shadow-xl max-w-md w-full p-8 sm:p-10 border border-[rgba(0,0,0,0.07)]">
        ...
        <p className="text-[#8B6E50] text-center mb-8">
          Votre commande <span className="font-bold text-[#FF3A03]">#{orderId}</span> a été confirmée.
        </p>
        ...
        <div className="bg-[#FFFFFF] rounded-2xl p-6 mb-8">
          <div className="flex items-center justify-center mb-3">
            <Clock className="w-5 h-5 text-[#FF3A03] mr-2" />
            <span className="text-[#8B6E50] font-medium">Livraison prévue dans</span>
          </div>
          <p className="text-4xl font-bold text-[#FF3A03] text-center">
            25-35 min
          </p>
        </div>
        ...
        <button
          ...
          style={{ background: 'linear-gradient(135deg, #FF3A03, #CC2402)', boxShadow: '0 4px 16px rgba(234,60,12,0.35)' }}
        >
          SUIVRE MA COMMANDE
        </button>
        ...
        <button
          ...
          className="w-full inline-flex items-center justify-center gap-2 border border-[rgba(0,0,0,0.1)] text-[#1A0C00] font-bold py-4 px-6 rounded-2xl hover:bg-[#FFECDF] hover:border-[#FF3A03] hover:text-[#FF3A03] transition-all duration-300 mb-3 disabled:opacity-70"
        >
        ...
        <button
          ...
          className="w-full text-[#8B6E50] font-semibold py-3 hover:bg-[#FFECDF] hover:text-[#FF3A03] rounded-xl transition-colors duration-200"
        >
          Retour à l'accueil
        </button>
      </div>
